...
- 🎯 Entry points to execute your program using `python -m <flask_web3>` or `$ flask_web3` with basic CLI argument parsing.
...
---
# flask_web3 Flask Application

Awesome flask_web3 created by sambacha
...
```bash
git clone https://github.com/sambacha/flask-web3 flask_web3
cd flask_web3
make install
```
...
```bash
flask_web3 create-db   # run once
flask_web3 populate-db  # run once (optional)
flask_web3 add-user -u admin -p 1234  # ads a user
flask_web3 run
```
